...
function App() {
  ...
  const fetchItems = () => {
    fetch(
      "https://todolist-80055-default-rtdb.europe-west1.firebasedatabase.app/items/.json"
    )
  ...
  const deleteTodo = (id) => {
    fetch(
      `https://todolist-80055-default-rtdb.europe-west1.firebasedatabase.app/items/${id}.json`,
      {
        method: "DELETE",
      }
    )
